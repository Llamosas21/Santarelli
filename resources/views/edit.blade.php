...
@php
    $inputClasses = 'w-full rounded-lg border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:border-indigo-500 focus:ring-indigo-500 caret-indigo-500';
@endphp

<x-app-layout>
    {{-- Contenedor principal --}}
    <div class="bg-gray-50 dark:bg-slate-900 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto pt-12">
            ...
            <form action="{{ route('reservas.update', $reserva->id) }}" method="POST">
                ...
                <div class="bg-white dark:bg-slate-800 shadow-lg rounded-2xl border border-gray-200 dark:border-slate-700 overflow-hidden">
                    <div class="p-6 sm:p-8 space-y-8">

                        <div>
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-6">Detalles de la Reserva</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                                <div>
                                    <label for="lugar_id" class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Lugar destino</label>
                                ...
                                <div>
                                    <label for="fecha_salida" class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Fecha de salida</label>
                                ...
                                <div>
                                    <label for="monto" class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Precio total</label>
                                ...
                                <div>
                                    <label for="fecha_regreso" class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Fecha de regreso</label>
                                ...
                                <div class="md:col-span-2" x-data="{ estado: '{{ old('estado', $reserva->estado) }}' }">
                                    <label for="estado" class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Estado</label>
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-6">Gestión de Micros</h3>
                            
                            <div class="bg-gray-100 dark:bg-slate-900/70 p-4 rounded-lg">
                                <h4 class="font-semibold mb-3 text-gray-900 dark:text-gray-300">Micros registrados</h4>
                                ...
                                @if($microsAgrupados->isNotEmpty())
                                    <div class="overflow-x-auto rounded-lg">
                                        <table class="min-w-full text-sm">
                                            ...
                                            <tfoot class="bg-gray-200 dark:bg-slate-700">
                                                <tr>
                                                    <td class="px-4 py-2 text-left font-bold text-gray-900 dark:text-gray-200" colspan="1">TOTAL</td>
                                                    <td class="px-4 py-2 text-center font-bold text-gray-900 dark:text-gray-200">
                                ...
                                @else
                                    <p class="text-sm text-gray-500 dark:text-gray-400 italic py-2">No hay micros asignados.</p>
                                @endif
                            </div>
                            <div class="mt-6">
                                <h4 class="font-semibold mb-3 text-gray-900 dark:text-gray-300">Agregar nuevo micro a la reserva</h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-100 dark:bg-slate-900/70 p-4 rounded-lg">
                                    <div>
                                        <label for="nuevo_tipo_micro_id" class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Tipo de micro</label>
                                    ...
                                    <div>
                                        <label for="nueva_cantidad_micro" class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Cantidad</label>
                    ...
                    <div class="px-6 sm:px-8 py-4 bg-gray-50 dark:bg-slate-800/50 border-t border-gray-200 dark:border-slate-700 flex items-center justify-end gap-x-6">
                        <a href="{{ route('clientes.show', $reserva->cliente_id) }}" class="text-sm font-semibold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition">Cancelar</a>
